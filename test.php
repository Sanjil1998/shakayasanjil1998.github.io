<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <!-- center content -->
        <div class="invisible col-md-2 fixed"><!--ghost div to push middle section offset--></div>
        <div class="col fluid d-flex flex-column p-0">
            <nav id="topNav" class="navbar navbar-expand-md fixed-top navbar-dark bg-primary">
                <a class="navbar-brand" href="#first">Bootstrap 4 Codeply</a>
            ...
            <div class="flex-grow">
                <div class="col-12 py-4">
                        <h5 class="text-primary hidden-sm-down">(Fixed-position)-(Fluid)-(Fixed-width) <span class="small">(alt "Holy Grail" Layout)</span></h5>
